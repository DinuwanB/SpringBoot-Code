package dev.nod.kafkatutorial;

import com.fasterxml.jackson.core.JsonProcessingException;
import com.fasterxml.jackson.databind.ObjectMapper;
import dev.nod.kafkatutorial.config.KafkaConfigProps;
import dev.nod.kafkatutorial.domain.CustomerVisitEvent;
...
public class Application {
	...
	public ApplicationRunner runner(final KafkaTemplate<String, String> kafkaTemplate, final KafkaConfigProps kafkaConfigProps) throws JsonProcessingException {
		...
		final CustomerVisitEvent event = CustomerVisitEvent
				.builder()
