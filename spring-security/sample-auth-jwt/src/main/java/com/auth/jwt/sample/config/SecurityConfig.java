package com.auth.jwt.sample.config;

import com.auth.jwt.sample.filter.JwtAuthFilter;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity htppSecurity) throws Exception {
        ...
        htppSecurity.csrf(AbstractHttpConfigurer::disable)
