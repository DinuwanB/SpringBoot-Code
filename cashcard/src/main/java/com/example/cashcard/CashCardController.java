...
public class CashCardController {
    ...
    @PostMapping
    private ResponseEntity<Void> createCashCard(@RequestBody CashCard cashCardRequestBody,
                                                UriComponentsBuilder uriComponentsBuilder,
                                                Principal principal) {

        CashCard cashCardWithOwner = new CashCard(null, cashCardRequestBody.amount(), principal.getName());
