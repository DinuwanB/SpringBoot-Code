...
public class DataSourceConfiguration {
    ...
    @Bean
    @Primary
    @ConfigurationProperties("app.datasource.blogs")
    ...
    public HikariDataSource blogDataSource(DataSourceProperties blogDataSourceProperties) {
        return blogDataSourceProperties
    ...
    @Bean
    DataSourceScriptDatabaseInitializer blogDataSourceScriptDatabaseInitializer(
    ...
    @Bean
    DataSourceScriptDatabaseInitializer subscriberDataSourceScriptDatabaseInitializer(
